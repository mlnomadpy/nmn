...
def test_feature_map_alternatives():
    ...
    print(
        f"{'Approach':<25} | {'dot=-0.5':>10} | {'dot=0.0':>10} | {'dot=0.5':>10} | {'dot=0.9':>10}"
    )
    print("-" * 75)
    ...
    print(
        f"{'Exact YAT':<25} | {exact_vals[-0.5]:>10.4f} | {exact_vals[0.0]:>10.4f} | {exact_vals[0.5]:>10.4f} | {exact_vals[0.9]:>10.4f}"
    )
    ...
    for name, feature_fn in approaches:
        ...
        print(
            f"{name:<25} | {approx_vals[-0.5]:>10.4f} | {approx_vals[0.0]:>10.4f} | {approx_vals[0.5]:>10.4f} | {approx_vals[0.9]:>10.4f}"
        )
