...
def test_yat_nmn_instantiation():
    ...
    try:
        ...
        layer = YatNMN(in_features=10, out_features=5)
...
def test_yat_nmn_no_bias():
    ...
    try:
        ...
        layer = YatNMN(in_features=10, out_features=5, bias=False)
...
def test_yat_nmn_no_alpha():
    ...
    try:
        ...
        layer = YatNMN(in_features=10, out_features=5, alpha=False)
...
def test_yat_nmn_custom_epsilon():
    ...
    try:
        ...
        epsilon = 1e-6
        layer = YatNMN(in_features=10, out_features=5, epsilon=epsilon)
