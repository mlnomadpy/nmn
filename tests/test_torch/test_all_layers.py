...
class TestConvLayersComprehensive:
    ...
    @pytest.mark.parametrize(
        "layer_name,kwargs,input_shape,expected_shape", CONV_LAYER_CONFIGS
    )
...
class TestConvTransposeLayersComprehensive:
    ...
    @pytest.mark.parametrize(
        "layer_name,kwargs,input_shape,expected_shape", CONV_TRANSPOSE_CONFIGS
    )
    def test_output_shape(self, layer_name, kwargs, input_shape, expected_shape):
...
class TestDropConnect:
    ...
    def test_dropconnect_disabled(self):
        ...
        layer = YatConv2D(
            in_channels=3, out_channels=8, kernel_size=3, use_dropconnect=False
        )
        layer.train()
...
class TestEdgeCases:
    ...
    def test_dilation(self):
        ...
        layer = YatConv2D(in_channels=3, out_channels=8, kernel_size=3, dilation=2)
        x = torch.randn(2, 3, 16, 16)
    ...
    def test_grouped_convolution(self):
        ...
        layer = YatConv2D(in_channels=6, out_channels=12, kernel_size=3, groups=3)
