...
def test_yat_conv_transpose_all_variants_with_device():
    ...
    try:
        ...
        layer1d = YatConvTranspose1D(
            in_channels=8, out_channels=4, kernel_size=2, stride=2, device="cpu"
        )
        ...
        layer2d = YatConvTranspose2D(
            in_channels=128, out_channels=64, kernel_size=2, stride=2, device="cpu"
        )
        ...
        layer3d = YatConvTranspose3D(
            in_channels=16, out_channels=8, kernel_size=2, stride=2, device="cpu"
        )
...
def test_yat_conv_transpose2d_dtype_parameter():
    ...
    try:
        ...
        layer_f32 = YatConvTranspose2D(
            in_channels=16, out_channels=8, kernel_size=2, stride=2, dtype=torch.float32
        )
        ...
        layer_f64 = YatConvTranspose2D(
            in_channels=16, out_channels=8, kernel_size=2, stride=2, dtype=torch.float64
        )
