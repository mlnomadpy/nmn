...
| NAM / IMQ / generic smooth comparison | Matched task, topology, supervision, fit budget, effects and serving costs | Native IMQ/tanh alternatives, matched-routing CPU replay runner, parameter/precision/cost records | Training lifecycle, task-matched fitting, acquisition/certification baselines |
